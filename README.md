...
```
**Это означает, что nginx1 может проксировать:**
**- либо в nginx2**
...
"Mounts": [
            {
                ...
                "Mode": "ro",
```
**По времени я не засекала точно, сколько я делала само задание, но быстро, видно в репозитории, что создано все было вчера. Примерно... 1,5 часа вместе с подумать.**
**Я больше времени потратила на понятное и приятное глазам описание в стиле маркдаун в файле README.md (по расширению файла и так понятно, что в стиле маркдаун)**
